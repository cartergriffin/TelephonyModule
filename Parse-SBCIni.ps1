# adding new function to improve atatrunkgroup logic
# need to modularize, make functions for trunkgroup, dial plan
# ip2ipinbound and outbound manipulation, parse each one just like this one 
